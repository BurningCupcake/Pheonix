    ...
    var body: some View {
        Form {
            ...
            Section(header: Text("Eye Tracking Settings")) {
                ...
                Slider(value: $settings.eyeTrackingAccuracyThreshold, in: 0.0...1.0, label: {
            ...
            Section(header: Text("Dynamic Calibration Settings")) {
                ...
                Slider(value: $settings.dynamicCalibrationAnimationDuration, in: 0.0...5.0, label: {
            ...
            Section(header: Text("Swipe-to-Type Settings")) {
                ...
                Slider(value: $settings.swipeSensitivity, in: 0.0...1.0, label: {
            ...
            Section(header: Text("Blink Gesture Settings")) {
                ...
                Slider(value: $settings.blinkGestureDurationThreshold, in: 0.0...1.0, label: {
